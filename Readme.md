...
```sh
git clone --recurse-submodules https://github.com/Alzymologist/flasher
```
...
Usage: flasher  [options...] [SUBCOMMAND: connect, crc, erase, halt, id, read, reset, run, write, ]
...
Options:
      ...
      -l,--length : Length of the memory region to read (in bytes). [required]
