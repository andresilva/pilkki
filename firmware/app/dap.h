...
#define EFM32_DPID_4      0x6BA02477  // PG
...
#define EFM32_AHBAP_ID_3  0X84770001  //PG
#define STM32_AHBAP_ID_3  0X14770015  //STM32
...
#define AP_CSW_DEFAULT 0x23000002// (AP_CSW_32BIT_TRANSFER | AP_CSW_MASTERTYPE_DEBUG | AP_CSW_HPROT)
...
//#define SWCLK_CLR() DCK_GPIO_Port->BSRR = GPIO_BSRR_BR3
////
//#define SWDIO_OUT(bit) {if ( bit ) SWDIO_SET(); else SWDIO_CLR();}
////#define SWDIO_IN() ((GPIO->P[SWDIO_PORT].DIN >> SWDIO_PIN) & 0x1)
//
//#define SWDIO_IN()  SWD_R
////#define SWDIO_OUT(bit) SWD_W(bit)
//
////#define SWDIO_SET() SWD_W(1)
////#define SWDIO_CLR() SWD_W(0)
////
////#define SWCLK_SET() SWD_C(1)
////#define SWCLK_CLR() SWD_C(0)
//
//
//#define SWCLK_CYCLE()   \
//  SWCLK_CLR();          \
